...
export class EditDocumentComponent implements OnInit {
  ...
  show() {
    ...
    if (options.headers["Content-Language"] == "es") {
      ...
      this.http.get(this.general.api + "admin/documents/" + this.data.id ,options).subscribe(( data : any )=> {
        this.informacion = {
  ...
  downEn() {
    ...
    this.general.downCode.show((pass: string) => {
      this.http.post(this.general.api + "admin/documents/" + this.data.id + "/download",{ password: pass }, { headers: options.headers, responseType: 'blob' as 'json' }).subscribe((resp: any) => {
